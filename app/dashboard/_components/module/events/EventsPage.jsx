...
const eventTypes = {
  live: { label: "Live", icon: Radio, className: "bg-red-500/10 text-red-600 border-red-500/20" },
  virtual: { label: "Virtual", icon: Monitor, className: "bg-blue-500/10 text-blue-600 border-blue-500/20" },
  upcoming: { label: "Upcoming", icon: CalendarClock, className: "bg-warning/10 text-warning border-warning/20" },
  successful: { label: "Successful", icon: Trophy, className: "bg-success/10 text-success border-success/20" },
};
...
const initialEvents = [
  {
    ...
    type: "upcoming",
    description: "Annual running event for accountants and finance professionals.",
  ...
  },
  {
    ...
    type: "virtual",
    description: "Join from anywhere in the world! Track your run with any GPS app.",
    organizer: "Run Rise Nation",
    packages: [
  ...
  },
  {
    ...
    type: "successful",
    description: "Team building event for corporate organizations - Successfully completed!",
  ...
  },
  {
    ...
    type: "successful",
    description: "Annual night run - Successfully completed with 380 participants!",
    organizer: "Run Rise Nation",
    packages: [
...
export default function EventsPage() {
  ...
  const [newPackages, setNewPackages] = useState([{ distance: "", price: "", slots: "" }]);
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage your running events with packages</p>
        </div>
          ...
          <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid gap-2">
                ...
                <Textarea id="description" placeholder="Event details..." rows={3} />
              </div>
              ...
              <div className="border-t border-border pt-4 mt-2">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <Label className="text-base font-semibold">Registration Packages</Label>
                    <p className="text-sm text-muted-foreground">Add different distance packages with pricing</p>
                  </div>
                    ...
                    <div key={index} className="flex gap-3 items-end p-3 bg-muted/50 rounded-lg">
                      <div className="flex-1 grid gap-2">
                        ...
                        <Input
                          placeholder="e.g., 5km"
                          value={pkg.distance}
                          onChange={(e) => updatePackage(index, "distance", e.target.value)}
                        />
                      </div>
                      <div className="flex-1 grid gap-2">
                ...
                <CardContent className="pt-0">
                  <div className="flex flex-wrap gap-4 text-sm">
                    ...
                    <div className="flex items-center gap-2 ml-auto">
                      ...
                      <span className="font-semibold text-foreground">{event.totalRegistrations}</span>
                          ...
                          >
                            ...
                            <div className="space-y-1 text-sm">
                              <div className="flex justify-between text-muted-foreground">
                                ...
                                <span className="font-medium text-foreground">{pkg.registered}/{pkg.slots}</span>
                              </div>
                              <div className="w-full bg-muted rounded-full h-2 overflow-hidden">
                                <div
                                  className="h-full bg-primary transition-all"
                                  style={{ width: `${(pkg.registered / pkg.slots) * 100}%` }}
                                />
                              </div>
