        ...
        <CardContent className="pt-6">
          ...
          <Accordion type="multiple">
            ...
            <AccordionItem value="health">
              <AccordionTrigger>
                Eligibility & Health Responsibility
              </AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="safety">
              ...
              <AccordionContent>
                ...
                shortcuts, or unauthorized assistance may result in
                disqualification.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="liability">
              ...
              <AccordionContent>
                RunRise Nation shall not be held liable for injury, illness,
                loss, or damage arising before, during, or after events.
              </AccordionContent>
            </AccordionItem>
