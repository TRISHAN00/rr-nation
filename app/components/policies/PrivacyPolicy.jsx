      ...
      <Card className="max-w-5xl mx-auto">
        <CardContent className="pt-6 space-y-6 leading-relaxed text-sm sm:text-base">
          ...
          <p>
            ...
            your data when you interact with our website, events, and services.
          </p>
          <p>
          ...
          <ul className="list-disc pl-5 sm:pl-6 space-y-2">
            ...
            <li>
              ...
              through cookies and analytics tools to understand user behavior
          ...
          <ul className="list-disc pl-5 sm:pl-6 space-y-2">
            ...
            <li>
              To enhance participant safety and emergency response during
              events.
            </li>
            <li>
              To improve our website, services, and overall community
              experience.
            </li>
            <li>
              To share relevant updates, offers, or initiatives related to
              RunRise Nation (you may opt out anytime).
            </li>
          </ul>
          ...
          <p>
            All partners are expected to uphold strict data protection
            standards.
          </p>
          ...
          <p>
            ...
            safeguard your information against unauthorized access, loss, or
            misuse.
          </p>
          <p>
