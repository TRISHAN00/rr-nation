    ...
    >
      ...
      <div className="relative p-4 flex flex-col z-10">
        ...
        <div className="px-5 sm:px-6 py-5 flex flex-col gap-4">
          ...
          <div className={`bg-brand h-1 w-12 transition-colors duration-300 ${href ? "group-hover:bg-white" : ""}`}></div>
          ...
          <div className="flex items-start gap-4 sm:gap-6">
            ...
            <div className="relative h-16 w-16 rounded-lg overflow-hidden shrink-0">
              ...
              <div className={`relative z-10 bg-[#090909] h-full w-full flex flex-col items-center justify-center transition-colors duration-300 ${href ? "group-hover:bg-transparent" : ""}`}>
