...
export default function EventCouponManager({ event }) {
  ...
  const handleConfirmDelete = async () => {
    await handleDeleteCoupon(itemToDelete);
  ...
  return (
    <>
                        ...
                        <TableRow key={coupon.id} className="hover:bg-muted/5">
                          ...
                          <TableCell className="text-right pr-6">
                            <Button
                              ...
                              // FIX: Call openDeleteModal instead of handleDeleteCoupon directly
      ...
      <ConfirmModal
        ...
        title="Delete Coupon?"
        description="This will permanently remove this discount code from the event."
      />
    </>
  );
}
